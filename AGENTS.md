...
| Calculator | `BroccoliCore/CalculatorEngine.swift` | Calculation stays on device and independent of UI state. Only a dated currency-rate snapshot is downloaded, and a missing or stale rate is never shown as current. |
