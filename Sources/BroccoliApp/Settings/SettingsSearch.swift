...
struct SettingsSearchItem: Identifiable {
    ...
    static let all: [Self] = [
        ...
        .init(id: "web-search", title: "Web Search", subtitle: "Search", destination: .section(.search), terms: "google duckduckgo web internet browser fallback no results"),
        ...
        .init(id: "window-management", title: "Window Management", subtitle: "Window Management", destination: .section(.windows), terms: "rectangle snap tile resize move window shortcut monitor display larger smaller quarter third sixth nudge almost maximize"),
